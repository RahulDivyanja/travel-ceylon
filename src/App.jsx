...
import ForgotPwOne from"./pages/Auth/Forgot-pwone";
import ForgotPwTwo from"./pages/Auth/Forgot-pwtwo";
import ForgotPwThree from"./pages/Auth/Forgot-pwthree";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/registration/hotel-step-three"
          element={<HotelStepThree />}
        />
        <Route
          path="/registration/hotel-step-four"
          element={<HotelStepFour />}
        />
        <Route
          path="/registration/hotel-step-five"
          element={<HotelStepFive />}
        />
        ...
        <Route
          path="/registration/taxi-step-three"
          element={<TaxiStepThree />}
        />
        ...
        <Route
          path="/registration/guide-step-three"
          element={<GuideStepThree />}
        />
        <Route
          path="/registration/guide-step-four"
          element={<GuideStepFour />}
        />
        <Route path="/signin" element={<Signin />} />
        <Route path="/signup" element={<Signup />} />
        <Route path="/forgot-password" element={<ForgotPwOne/>}/>
        <Route path="/forgotpw-two" element={<ForgotPwTwo/>}/>
        <Route path="/forgotpw-three" element={<ForgotPwThree/>}/>
      </Routes>
    </Router>
  );
}
