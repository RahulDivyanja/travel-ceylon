  ...
  return (
    <div className='bg-white rounded-3xl shadow-2xl overflow-hidden max-w-full p-4 sm:p-7 z-50'>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="text-left text-sm font-semibold">Where you want to go</div>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          ...
          <div className="flex flex-col flex-1">
            ...
            <div className="relative">
              <select
                ...
                className="w-full p-3 pl-10 border border-gray-400 rounded-md bg-white text-gray-500 appearance-none"
              >
          ...
          {/* Pickup Date */}
          <div className="flex flex-col flex-1">
            <label className="text-sm font-medium text-gray-700 mb-1 text-left">Pick Up</label>
            <div className="relative">
              <input
                type="date"
                name="pickupDate"
                ...
                onChange={handleChange}
                className="w-full p-3 pl-10 border border-gray-400 rounded-md text-gray-700"
              />
              <CalendarDays className="text-gray-800 absolute top-[35%] left-3" size={18} />
            </div>
          </div>
        ...
        <div className="flex justify-end pt-2">
          <button
            type="submit"
            className="bg-[#8dd3bb] hover:bg-teal-400 text-black text-sm sm:text-md font-semibold py-2 px-6 rounded-md transition duration-200"
          >
            Search
          </button>
        </div>
