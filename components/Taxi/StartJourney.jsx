...
export default function StartJourney({vehicle}) {
  ...
  return (
    <div className="mx-auto">
      <h2 className="text-2xl font-bold text-gray-600 my-8 text-center sm:text-left">Start the Journey</h2>
        ...
        <div className="w-full md:w-3/5 p-6 md:p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              <label className="text-sm text-gray-600 mb-1 text-left">Pickup</label>
            ...
            <div className="flex flex-col mb-2">
              <label className="text-sm text-gray-600 mb-1 text-left">Drop</label>
              <div className="flex items-center border rounded-md p-2">
            ...
            {/* Date */}
            <div className="flex flex-col">
              <label className="text-sm text-gray-600 mb-1 text-left">Date</label>
              <div className="flex items-center border rounded-md p-2">
            ...
            {/* Time */}
            <div className="flex flex-col">
              <label className="text-sm text-gray-600 mb-1 text-left">Time</label>
              <div className="flex items-center border rounded-md p-2">
          ...
          <div className="flex justify-center md:justify-end mt-6">
            <button className="bg-[#8DD3BB] hover:bg-[#81dfbe] hover:text-white text-black font-semibold py-2 px-8 rounded-md">
              Select
            </button>
          </div>
        </div>
